...
| `GET /v5/real-world-assets/quotes/latest` | Quote by ticker: tokenized aggregate values + underlying on-chain tokens + TradFi venue metadata when supplied; wrapper-vs-blended comparisons |
